		...
		<div className="py-4 border-b border-zinc-800">
			<nav className="flex items-center gap-2 max-w-[1200px] mx-auto">
				<a href="" className="py-1.5 px-3 text-zinc-300 inline-flex items-center text-sm gap-1.5 font-medium rounded-full border border-transparent hover:border-zinc-800 group">
					<ListVideo className="group-hover:text-teal-400 size-4" />
          Uploads
				</a>

				<a href="" className="py-1.5 px-3 bg-zinc-800 text-zinc-100 inline-flex items-center text-sm gap-1.5 font-medium rounded-full border border-transparent hover:border-zinc-800 group">
					<Tags className="text-teal-400 size-4" />
          Tags
				</a>
